  ...
  return (
    <footer className="text-white flex flex-col justify-center items-center pb-6 absolute inset-x-0 bottom-0 opacity-50">
      ...
      <div className="flex flex-row text-sm font-normal">
        <div className="no-underline lg:underline underline-offset-2 cursor-pointer">Terms of Use</div>
        <ul className="list-outside list-disc ml-6">
          <li></li>
        </ul>
        <div className="no-underline lg:underline underline-offset-2 cursor-pointer">Privacy Policy</div>
      </div>
    </footer>
  );
};
